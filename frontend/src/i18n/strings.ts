...
export const STRINGS: Record<Lang, Dict> = {
  en: {
    ...
    // home
    home_membership_title: "Membership tiers",
    home_membership_sub: "Five institutional tiers — Bronze to Platinum. Tap a tier to compare benefits and request membership.",
    home_membership_cta: "View membership",
    home_summary:
    ...
    // team console
    team_link: "Team console",
    team_title: "Team console",
    team_sub: "Review membership requests and update their status. Applicants are emailed when a status changes.",
    team_key_placeholder: "Team access key",
    team_unlock: "Unlock",
    team_invalid_key: "That access key is not valid.",
    team_lock: "Lock console",
    team_all: "All",
    team_empty: "No requests in this view yet.",
    team_set_status: "Set status",
    team_confirm_title: "Change status?",
    team_confirm_msg: "The applicant will be notified by email.",
    team_confirm_yes: "Confirm",
    team_cancel: "Cancel",
    team_updated: "Status updated and applicant notified.",
    team_error: "Could not update. Please try again.",
    team_message: "Message",
    team_requested: "Requested",
    back: "Back",
  ...
  fr: {
    ...
    home_membership_title: "Paliers d’adhésion",
    home_membership_sub: "Cinq paliers institutionnels — de Bronze à Platine. Touchez un palier pour comparer les avantages et demander l’adhésion.",
    home_membership_cta: "Voir l’adhésion",
    home_summary:
    ...
    team_link: "Console équipe",
    team_title: "Console équipe",
    team_sub: "Examinez les demandes d’adhésion et mettez à jour leur statut. Les candidats sont informés par e-mail à chaque changement.",
    team_key_placeholder: "Clé d’accès équipe",
    team_unlock: "Déverrouiller",
    team_invalid_key: "Cette clé d’accès n’est pas valide.",
    team_lock: "Verrouiller la console",
    team_all: "Toutes",
    team_empty: "Aucune demande dans cette vue pour le moment.",
    team_set_status: "Définir le statut",
    team_confirm_title: "Changer le statut ?",
    team_confirm_msg: "Le candidat sera informé par e-mail.",
    team_confirm_yes: "Confirmer",
    team_cancel: "Annuler",
    team_updated: "Statut mis à jour et candidat informé.",
    team_error: "Mise à jour impossible. Veuillez réessayer.",
    team_message: "Message",
    team_requested: "Demandée le",
    back: "Retour",
  ...
  ar: {
    ...
    home_membership_title: "فئات العضوية",
    home_membership_sub: "خمس فئات مؤسسية — من البرونزية إلى البلاتينية. اضغط على فئة لمقارنة المزايا وطلب العضوية.",
    home_membership_cta: "عرض العضوية",
    home_summary:
    ...
    team_link: "لوحة الفريق",
    team_title: "لوحة الفريق",
    team_sub: "راجع طلبات العضوية وحدّث حالتها. يتم إخطار المتقدمين بالبريد الإلكتروني عند تغيّر الحالة.",
    team_key_placeholder: "مفتاح وصول الفريق",
    team_unlock: "فتح",
    team_invalid_key: "مفتاح الوصول هذا غير صالح.",
    team_lock: "قفل اللوحة",
    team_all: "الكل",
    team_empty: "لا توجد طلبات في هذا العرض حتى الآن.",
    team_set_status: "تعيين الحالة",
    team_confirm_title: "تغيير الحالة؟",
    team_confirm_msg: "سيتم إخطار المتقدم بالبريد الإلكتروني.",
    team_confirm_yes: "تأكيد",
    team_cancel: "إلغاء",
    team_updated: "تم تحديث الحالة وإخطار المتقدم.",
    team_error: "تعذّر التحديث. يرجى المحاولة مرة أخرى.",
    team_message: "الرسالة",
    team_requested: "تاريخ الطلب",
    back: "رجوع",
